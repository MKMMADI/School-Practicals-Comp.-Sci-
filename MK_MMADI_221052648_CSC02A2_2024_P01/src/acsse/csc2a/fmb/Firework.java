...
public class Firework
{
	...
	public void setFirework_Colour(int intColour,E_COLOUR newFireWork)
	{
		if(((intColour >0) && (intColour<8)) && newFireWork!=null)
		{
			this.Firework_Colour.Set_Colour(intColour,newFireWork);
		}else
		{
